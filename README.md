...
These are the shortcuts added to, or modified from, the default `textarea` editor:
...
This project todois free of contributions generated by large languages models (LLMs) and chatbots.
